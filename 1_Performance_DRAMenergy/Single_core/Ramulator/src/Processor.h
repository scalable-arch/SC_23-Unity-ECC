...
public:
    ...
    //int l1_size = 1 << 15; // 32KB
    // for Rebuttal
    int l1_size = 1 << 15 + 1 << 14; // 48KB = 32KB + 16KB
    int l1_assoc = 1 << 3; // 8-way
    int l1_blocksz = 1 << 6; // 64byte cacheline (cache block size)
    int l1_mshr_num = 16;

    // int l2_size = 1 << 18; // 256KB
    // for Rebuttal
    int l2_size = 1 << 21; // 2MB
    int l2_assoc = 1 << 3; // 8-way
    int l2_blocksz = 1 << 6; // 64byte cacheline (cache block size)
    int l2_mshr_num = 16;
...
public:
    ...
    int l3_size = 1 << 23; // 8MB
    int l3_assoc = 1 << 3; // 8-way
    int l3_blocksz = 1 << 6; // 64byte cacheline (cache block size)
