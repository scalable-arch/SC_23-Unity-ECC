...
int main(int argc, const char *argv[])
{
    ...
    string full_benchmark=argv[trace_start]; // new!!!!
    size_t pos = full_benchmark.rfind('.'); // new!!!!
    string benchmark=full_benchmark.substr(pos+1); // new!!!!
    configs.add("benchmark", benchmark); // new!!!!
