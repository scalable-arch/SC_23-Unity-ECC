...
public:
    DefaultFaultRateInfo() : FaultRateInfo() {
        // random single-bit error : transient, permanent
        //addFaultRate("r_sbit_t",BIT_FIT);

        //addFaultRate("sword-2p-t", 0.014* BIT_FIT);
        //addFaultRate("sword-2p-p", 0.003* BIT_FIT);
        //addFaultRate("sword-3p-t", 0.014* BIT_FIT);
        //addFaultRate("sword-3p-p", 0.003* BIT_FIT);
        //addFaultRate("sword-4p-t", 0.014* BIT_FIT);
        //addFaultRate("sword-4p-p", 0.003* BIT_FIT);
        //addFaultRate("r_sbit_p",BIT_FIT);

        //addFaultRate("b",BIT_FIT);
