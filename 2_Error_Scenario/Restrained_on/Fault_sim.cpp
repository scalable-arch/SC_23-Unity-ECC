...
enum FAULT_TYPE {SE_NE_NE=0, SE_SE_NE=1, SE_SE_SE=2, CHIPKILL_NE_NE=3, CHIPKILL_SE_NE=4, CHIPKILL_CHIPKILL_NE=5, DE_NE_NE=6, DE_DE_NE=7, DE_DE_DE=8, CHIPKILL_DE_NE=9}; // fault_type
